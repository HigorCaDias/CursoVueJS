<template>
	<div id="app" class="container">
		...
		<hr>
		<b-list-group>
			<!-- o ID passado no grupo (usuario, id) é o mesmo passado dentro do @carregar e excluir
			assim o Vue interpreta que o id referenciado é o mesmo do selecionado -->
...
export default {
	...
	methods: {
		// Função para limpar os dados selecionados
		limpar() {
			this.usuario.nome = ''
			this.usuario.email = ''
			this.id = null
